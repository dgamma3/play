    ...
    <el-drawer
     ...
     >
         ...
         <el-row justify="space-between">
           ...
           <el-col class="my-box" :xs="12" :sm="8" :md="6" :lg="4" :xl="3"  v-for="(item2, index2) in item.arr" :key="index2">
           <div :class="'live-item live-item-bg live-item-bg-'+color(item2.color, 4)+' '+color(item2.color, 3)" >

               <div class="o-item" style="width:100%;">
                 <div class="o-body">
                  <div class="o-info">
                  <div class="o-price"><img src="@/assets/img/star.png" >{{item2.open_price}}</div>
                  <div class="o-probability">{{ fixTwo(item2.probability) }}%</div>
                  </div>
...
/*      this.ws = ttWebSocket(
      ...
      this.ws = ttGet(
        "/api.php/common/get_battle", { battle_type: battle_type },
        (res) => {
          this.loadingIndex = false;
          if (res.code == 200) {
            this.battle = res.data.battle;
