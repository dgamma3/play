    ...
    <div class="bg-all">
      ...
      <template v-else>
        <el-row>
          <el-col :span="24">
            <div
              style="margin:auto;color:#fff;font-size: 18px;min-height:150px;line-height:150px;text-align: center;"
            >
              网站维护中，敬请期待.........
            </div>
          </el-col>
...
<script>
import { ttGet } from "@/utils/util.js";
import navbar from "./navbar";
import bottom from "./bottom";
import tabbar from "./tabbar";
import { getStore, removeStore } from "@/utils/store.js";
