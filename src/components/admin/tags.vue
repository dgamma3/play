<template>
  <div class="avue-tags" style="position: fixed;top: 60px;width: 100%;z-index: 999;"
       v-if="showTag">
    <!-- tag盒子 -->
    <div v-if="contextmenuFlag"
      ...
      <div class="item"
           @click="clearCacheTags">清除缓存
      </div>
      <div class="item"
           @click="closeOthersTags">关闭其他
      </div>
      <div class="item"
           @click="closeAllTags">关闭所有
      </div>
    </div>
    <div :style="'padding-left: ' + l_left + 'px'">
      <div class="avue-tags__box"
        ...
        <el-tabs v-model="active"
          ...
          <el-tab-pane :key="item.value"
                       v-for="item in tagList" v-if="item.value.indexOf('/desk/detail') == -1"
